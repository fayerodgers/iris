...
$IRIS_HOME/iris/bin/process_tokens.pl --user_list $USERS --annotations_path $ANNOTATIONS_DIR_PATH --apollo_pword $APOLLO_ADMIN_PASS --mysql_pword $MYSQL_PWORD --data_path $DATA_DIR_PATH 

#write html files
$IRIS_HOME/iris/bin/write_html_files.pl --annotations_path $ANNOTATIONS_DIR_PATH --mysql_pword $MYSQL_PWORD --data_path $DATA_DIR_PATH
...
#process annotations
$IRIS_HOME/iris/bin/process_annotations.pl --user_list $USERS --annotations_path $ANNOTATIONS_DIR_PATH --apollo_pword $APOLLO_ADMIN_PASS --mysql_pword $MYSQL_PWORD --data_path $DATA_DIR_PATH
